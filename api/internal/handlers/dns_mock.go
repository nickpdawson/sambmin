...
func handleListDNSZonesMock(w http.ResponseWriter, r *http.Request) {
	zones := []mockDNSZone{
		{Name: "example.com", Type: "forward", Backend: "samba", Records: 87, Dynamic: true, SOASerial: 2026021701, Status: "healthy"},
		...
		{Name: "_msdcs.example.com", Type: "forward", Backend: "samba", Records: 24, Dynamic: true, SOASerial: 2026021701, Status: "healthy"},
		{Name: "lab.example.com", Type: "forward", Backend: "bind9", Records: 15, Dynamic: false, SOASerial: 2026020101, Status: "warning"},
		{Name: "staging.example.com", Type: "forward", Backend: "bind9", Records: 8, Dynamic: false, SOASerial: 2026011501, Status: "stale"},
	}
...
func handleListDNSRecordsMock(w http.ResponseWriter, r *http.Request) {
	...
	records := []mockDNSRecord{
		{Name: "@", Type: "SOA", Value: "dc1.example.com. admin.example.com. 2026021701 900 600 86400 3600", TTL: 3600, Dynamic: false},
		{Name: "@", Type: "NS", Value: "dc1.example.com.", TTL: 900, Dynamic: false},
		{Name: "@", Type: "NS", Value: "dc2.example.com.", TTL: 900, Dynamic: false},
		...
		{Name: "@", Type: "MX", Value: "mail.example.com.", TTL: 600, Priority: 10, Dynamic: false},
		{Name: "www", Type: "CNAME", Value: "web.example.com.", TTL: 600, Dynamic: false},
		{Name: "web", Type: "A", Value: "10.10.1.60", TTL: 600, Dynamic: false},
		{Name: "vpn", Type: "A", Value: "10.10.1.1", TTL: 300, Dynamic: false},
		{Name: "_ldap._tcp", Type: "SRV", Value: "dc1.example.com.", TTL: 600, Priority: 0, Weight: 100, Port: 389, Dynamic: true},
		{Name: "_ldap._tcp", Type: "SRV", Value: "dc2.example.com.", TTL: 600, Priority: 0, Weight: 100, Port: 389, Dynamic: true},
		{Name: "_kerberos._tcp", Type: "SRV", Value: "dc1.example.com.", TTL: 600, Priority: 0, Weight: 100, Port: 88, Dynamic: true},
		{Name: "_kerberos._tcp", Type: "SRV", Value: "dc2.example.com.", TTL: 600, Priority: 0, Weight: 100, Port: 88, Dynamic: true},
		{Name: "_gc._tcp", Type: "SRV", Value: "dc1.example.com.", TTL: 600, Priority: 0, Weight: 100, Port: 3268, Dynamic: true},
		...
		{Name: "_dmarc", Type: "TXT", Value: "v=DMARC1; p=quarantine; rua=mailto:admin@example.com", TTL: 600, Dynamic: false},
	}
...
func handleDNSDiagnosticsMock(w http.ResponseWriter, r *http.Request) {
	respondJSON(w, http.StatusOK, map[string]any{
		"checks": []map[string]any{
			...
			{"name": "Stale Dynamic Records", "status": "warning", "message": "2 dynamic records older than 14 days: old-laptop.example.com, temp-vm.example.com"},
			{"name": "SOA Serial Consistency", "status": "pass", "message": "SOA serials match across all DCs for example.com"},
